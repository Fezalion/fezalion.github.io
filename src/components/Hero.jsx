...
const item = {
  hidden: { opacity: 0},
  show: { opacity: 1, transition: { duration: 0.5, ease: [0.5, 1, 0.89, 1] } },
};
        ...
        <div className="w-auto h-auto min-w-full py-32">
          ...
          >
            ...
            <motion.span
              ...
              animate="show"
            >
              <motion.span className="transform-gpu" variants={item}>F</motion.span>
              <motion.span className="transform-gpu" variants={item}>e</motion.span>
              <motion.span className="transform-gpu" variants={item}>z</motion.span>
              <motion.span className="transform-gpu" variants={item}>a</motion.span>
              <motion.span className="transform-gpu" variants={item}>l</motion.span>
              <motion.span className="transform-gpu" variants={item}>i</motion.span>
              <motion.span className="transform-gpu" variants={item}>o</motion.span>
              <motion.span className="transform-gpu" variants={item}>n</motion.span>
            </motion.span>
          </motion.h1>
          <motion.p
