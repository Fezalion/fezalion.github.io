        ...
        <div className="z-0 mx-auto max-w-screen-2xl px-4 sm:pb-16 lg:mb-0 lg:px-6">
          ...
          >
            <motion.article variants={item}>
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-800 lg:h-12 lg:w-12">
                <svg
                  className="h-5 w-5 text-secondary-600 lg:h-6 lg:w-6"
                  fill="currentColor"
                  viewBox="0 0 24 24"
