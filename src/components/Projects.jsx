        ...
        <div className="z-0 px-4 pb-8 mx-auto max-w-screen-2xl sm:pb-16 lg:px-6">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <article>
              ...
              <h3 className="w-auto mb-2 text-xl font-bold text-primary-100">
            ...
            <article>
              ...
              <p className="text-gray-400">
                I love racing games. Something I love more than racing games is drifting in racing games. I hate tuning cars for hours, so I made a tool to help me tune my cars to drift. This was made for <span className="text-secondary-500">Forza Horizon 4</span> but abandoned since newer titles came out.
              </p>
            </article>
          </div>
        </div>
